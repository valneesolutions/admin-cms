...
const blogsSeedData: Array<Record<string, any>> = [
  {
    title: 'Why Custom Software Development Is Cheaper Than You Think in the Long Run',
    slug: 'why-custom-software-development-is-cheaper',
    status: 'published',
    publishedAt: '2024-01-15T10:00:00.000Z',
    author: null, // Will be set after author is created
    category: 'Insights',
    summary: 'Discover how custom software development can save you money in the long term compared to off-the-shelf solutions.',
    content: '# Why Custom Software Development Is Cheaper Than You Think in the Long Run\n\nContent here...',
    ...
    metaDescription: 'Discover how custom software development can save you money in the long term.',
  },
  {
    title: 'How to Validate a Startup Idea Before Spending Money on Development',
    slug: 'how-to-validate-startup-idea',
    status: 'published',
    publishedAt: '2024-02-20T10:00:00.000Z',
    author: null,
    category: 'Startup Guide',
    summary: 'Learn effective strategies to validate your startup idea before investing in development.',
    content: '# How to Validate a Startup Idea Before Spending Money on Development\n\nContent here...',
    coverImage: null,
    tags: [{ tag: 'popular' }, { tag: 'latest' }, { tag: 'startup' }, { tag: 'validation' }],
    readingTime: '10 min',
    metaTitle: 'How to Validate a Startup Idea Before Spending Money',
    metaDescription: 'Learn effective strategies to validate your startup idea.',
  },
  {
    ...
    author: null,
    category: 'Startup Guide',
    summary: 'Understand why having a technical partner is crucial for startup success beyond just hiring developers.',
    content: '# Why Startups Need a Technical Partner, Not Just Developers\n\nContent here...',
    coverImage: null,
    tags: [{ tag: 'popular' }, { tag: 'latest' }, { tag: 'startup' }, { tag: 'partnership' }],
    readingTime: '12 min',
    metaTitle: 'Why Startups Need a Technical Partner, Not Just Developers',
    metaDescription: 'Understand why having a technical partner is crucial for startup success.',
  },
  {
    ...
    author: null,
    category: 'Technology',
    summary: 'Explore the true meaning of founder-friendly technology and how it benefits your startup.',
    content: "# What 'Founder-Friendly Tech' Actually Means\n\nContent here...",
    coverImage: null,
    tags: [{ tag: 'popular' }, { tag: 'latest' }, { tag: 'technology' }, { tag: 'founders' }],
    readingTime: '7 min',
  ...
  },
  {
    ...
    summary: 'Discover why non-technical founders often create superior MVPs and how to leverage this advantage.',
    content: '# Why Non-Technical Founders Often Build Better MVPs\n\nContent here...',
    coverImage: null,
    tags: [{ tag: 'popular' }, { tag: 'latest' }, { tag: 'mvp' }, { tag: 'non-technical' }],
    readingTime: '9 min',
    metaTitle: 'Why Non-Technical Founders Often Build Better MVPs',
    metaDescription: 'Discover why non-technical founders often create superior MVPs.',
  },
]
...
const caseStudiesSeedData: Array<Record<string, any>> = [
  {
    ...
    left_description: 'Advanced AI-powered optimization tools for better search visibility.',
    content: '# Saga AI\n\nAI Optimization & Search Visibility platform content...',
    page_url: '',
    tags: [{ tag: 'web-app' }, { tag: 'ai' }, { tag: 'optimization' }, { tag: 'search' }],
  ...
  },
  {
    ...
    left_description: 'Real-time monitoring and IoT medical dashboard solutions.',
    content: '# Thyne\n\nReal-time IoT medical dashboards content...',
    page_url: '',
    tags: [{ tag: 'app' }, { tag: 'web-app' }, { tag: 'iot' }, { tag: 'medical' }, { tag: 'dashboard' }],
    author_name: 'Valnee Team',
    author_image: '/valneeLogo.svg',
    is_active: true,
  ...
  },
  {
    ...
    left_description: 'Beautiful and high-converting Shopify storefront for premium jewelry brands.',
    content: '# Zoci\n\nPremium Shopify jewelry storefront content...',
    page_url: '',
    tags: [{ tag: 'landing-pages' }, { tag: 'ecommerce' }, { tag: 'shopify' }, { tag: 'jewelry' }],
    author_name: 'Valnee Team',
    author_image: '/valneeLogo.svg',
    is_active: true,
  ...
  },
  {
    ...
    left_description: 'Comprehensive case study of the Thyne AI platform with real-time IoT capabilities.',
    content: '# Thyne AI Case Study\n\nAI-powered medical IoT platform content...',
    page_url: 'https://play.google.com/store/apps/details?id=chawla_solution.com.thyne_jewls',
    tags: [{ tag: 'app' }, { tag: 'web-app' }, { tag: 'ai' }, { tag: 'iot' }, { tag: 'medical' }, { tag: 'case-study' }],
    author_name: 'Valnee Team',
    author_image: '/valneeLogo.svg',
    is_active: true,
  ...
  },
  {
    ...
    left_description: 'Rapid prototyping and MVP development for innovative startups.',
    content: '# Project Pluto\n\nInnovative MVP development project content...',
    page_url: '',
    tags: [{ tag: 'app' }, { tag: 'mvps' }, { tag: 'prototype' }, { tag: 'startup' }],
    author_name: 'Valnee Team',
    author_image: '/valneeLogo.svg',
    is_active: true,
  ...
  },
  {
    ...
    left_description: 'Case study of a high-converting landing page that drives conversions.',
    content: '# Layers Landing Page Case Study\n\nHigh-converting landing page design content...',
    page_url: '',
    tags: [{ tag: 'landing-pages' }, { tag: 'design' }, { tag: 'conversion' }, { tag: 'case-study' }],
    author_name: 'Valnee Team',
    author_image: '/valneeLogo.svg',
    is_active: true,
  ...
  },
  {
    ...
    left_description: 'Comprehensive SEO platform for improving search rankings.',
    content: '# Optirank Platform Case Study\n\nSEO optimization and ranking platform content...',
    page_url: '',
    tags: [{ tag: 'web-app' }, { tag: 'seo' }, { tag: 'ranking' }, { tag: 'platform' }, { tag: 'case-study' }],
    author_name: 'Valnee Team',
    author_image: '/valneeLogo.svg',
    is_active: true,
  ...
  },
  {
    ...
    left_description: 'Case study of an AI-powered content creation and ghostwriting platform.',
    content: '# Ghostwriter AI Case Study\n\nAI-powered content creation platform content...',
    page_url: '',
    tags: [{ tag: 'web-app' }, { tag: 'mvps' }, { tag: 'ai' }, { tag: 'content' }, { tag: 'ghostwriting' }, { tag: 'case-study' }],
    author_name: 'Valnee Team',
    author_image: '/valneeLogo.svg',
    is_active: true,
...
const seedData = async () => {
  ...
  for (const blogData of blogsSeedData) {
    ...
    if (existing.docs[0]) {
      ...
      const existingTagStrings = existingBlog.tags?.map((t: any) => t.tag) || []
      const requiredTags = blogData.tags?.map((t: any) => t.tag) || []
      
      const missingTags = requiredTags.filter((tag: string) => !existingTagStrings.includes(tag))
      
      if (missingTags.length > 0) {
        try {
          const updatedTags = [...existingBlog.tags || [], ...missingTags.map((tag: string) => ({ tag }))]
          ...
          console.log(`Updated blog tags for ${existingBlog.title}: added ${missingTags.join(', ')}`)
        } catch (error) {
    ...
    if (!placeholderImageId) {
      console.log(`Skipping blog creation for ${blogData.title} - no placeholder image available`)
      continue
    }
    ...
    try {
      ...
      console.log(`Created blog: ${created.title} (${created.slug}) with tags:`, 
        data.tags?.map((t: any) => t.tag).join(', '))
    } catch (error) {
  ...
  for (const caseStudyData of caseStudiesSeedData) {
    ...
    if (existing.docs[0]) {
      console.log(`Case study already exists: ${caseStudyData.title} (${caseStudyData.slug})`)
      ...
      // Check tags
      const existingTagStrings = existingCaseStudy.tags?.map((t: any) => t.tag) || []
      const requiredTags = caseStudyData.tags?.map((t: any) => t.tag) || []
      const missingTags = requiredTags.filter((tag: string) => !existingTagStrings.includes(tag))
      
      if (missingTags.length > 0) {
        updates.tags = [...existingCaseStudy.tags || [], ...missingTags.map((tag: string) => ({ tag }))]
      }
      ...
      if (Object.keys(updates).length > 0) {
        try {
          ...
          if (updates.category) updateMessages.push(`category: ${caseStudyData.category}`)
          if (updates.tags) updateMessages.push(`tags: added ${missingTags.join(', ')}`)
          console.log(`Updated case study ${existingCaseStudy.title}: ${updateMessages.join(', ')}`)
        } catch (error) {
          console.error(`Error updating case study ${caseStudyData.title}:`, error)
        }
      }
      continue
    }
    ...
    if (!placeholderImageId) {
      console.log(`Skipping case study creation for ${caseStudyData.title} - no placeholder image available`)
      continue
    }
    ...
    try {
      ...
      console.log(`Created case study: ${created.title} (${created.slug}) with category: ${created.category}`)
    } catch (error) {
  ...
  if (!placeholderImageId) {
    ...
    console.log('To create missing records, upload at least one image to the media library first.')
  }
  
  console.log('\nSeed data process completed!')
  console.log('\nExisting records were updated with tags/categories as needed.')
  console.log('To check which blogs/case studies were updated, look for "Updated" messages above.')
}
